...
/// Implements the 32-bit and 64-bit MurmurHash2 non-cryptographic hash functions.
///
/// MurmurHash2 is suitable for general hash-based lookup, but not for cryptographic use. This is a
/// Java port of Austin Appleby's public-domain SMHasher implementation with array, string, and
/// streaming helpers.
///
