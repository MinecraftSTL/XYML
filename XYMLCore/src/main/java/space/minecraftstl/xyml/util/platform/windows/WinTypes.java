...
/// Windows native data types shared by the launcher platform bindings.
///
/// @author Glavo
@NotNullByDefault
public interface WinTypes {
    ...
    /// Minimal `PROPVARIANT` layout for values XYML writes with [`IPropertyStore#SetValue`].
    ///
    ...
    final class PROPVARIANT extends Structure {
        ...
        /// Reserved; must be zero for values constructed by XYML.
