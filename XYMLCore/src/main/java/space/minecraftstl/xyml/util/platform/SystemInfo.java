...
import space.minecraftstl.xyml.util.DataSizeUnit;
import space.minecraftstl.xyml.util.platform.hardware.CentralProcessor;
import space.minecraftstl.xyml.util.platform.hardware.GraphicsCard;
import space.minecraftstl.xyml.util.platform.hardware.HardwareDetector;
import space.minecraftstl.xyml.util.platform.hardware.PhysicalMemoryStatus;
import space.minecraftstl.xyml.util.platform.linux.LinuxHardwareDetector;
import space.minecraftstl.xyml.util.platform.macos.MacOSHardwareDetector;
import space.minecraftstl.xyml.util.platform.windows.*;
