...
import static space.minecraftstl.xyml.download.java.JavaPackageType.*;
import static space.minecraftstl.xyml.util.Pair.pair;
import static space.minecraftstl.xyml.util.platform.Architecture.*;
import static space.minecraftstl.xyml.util.platform.OperatingSystem.*;
