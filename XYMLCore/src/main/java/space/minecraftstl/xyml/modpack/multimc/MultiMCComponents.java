...
public final class MultiMCComponents {
    ...
    static {
        ...
        // Check whether MultiMCComponents is 'space.minecraftstl.xyml.mod.multimc.MultiMCComponents'.
        ...
        if (new String(
            ...
            INSTALLER_PROFILE.put("Implementation", "Probably vanilla. Class location is not modified (space.minecraftstl.xyml.mod.multimc.MultiMCComponents).");
        } else {
