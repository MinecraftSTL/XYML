...
import space.minecraftstl.xyml.util.gson.JsonMap;
...
public final class MultiMCInstancePatch {
    public static final Library BOOTSTRAP_LIBRARY = new Library(new Artifact("space.minecraftstl.xyml", "mmc-bootstrap", "1.0"));
    ...
    public static ResolvedInstance resolveArtifact(List<MultiMCInstancePatch> patches, String versionID) {
...

        {
            ...
            mainClass = "space.minecraftstl.xyml.XYMLMultiMCBootstrap";
        }
