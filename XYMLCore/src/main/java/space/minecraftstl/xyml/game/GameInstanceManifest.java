...
import space.minecraftstl.xyml.util.ImmutableSequencedMap;
import space.minecraftstl.xyml.util.Lang;
import space.minecraftstl.xyml.util.gson.InstantTypeAdapter;
import space.minecraftstl.xyml.util.gson.JsonUtils;
import space.minecraftstl.xyml.util.gson.LowerCaseEnumTypeAdapter;
...
/// Immutable stored manifest for one installed game instance.
///
/// Nullable components represent fields omitted from the instance JSON and are resolved through inheritance or
/// patches before launch.
@NotNullByDefault
...
public record GameInstanceManifest(
    ...
    ///
    /// @param unresolved        original stored manifest
