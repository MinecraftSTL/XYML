...
/// Immutable partial manifest layered onto an installed game instance.
///
/// The `version` component describes the real loader or library version represented by the patch; it is not an
