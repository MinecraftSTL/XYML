...
/// [XoyzNBT](https://github.com/MinecraftSTL/XYML/tree/dev/libraries/xoyz-nbt) is XYML's modern Java library for
...
///
/// If you want to learn about the XoyzNBT API by reading the Javadoc, check the documentation of the following core classes:
///
