...
import space.minecraftstl.xyml.library.nbt.NBTPath;
import space.minecraftstl.xyml.library.nbt.internal.TextUtils;
import space.minecraftstl.xyml.library.nbt.internal.path.NBTPathImpl;
import space.minecraftstl.xyml.library.nbt.internal.path.NBTPathNode;
