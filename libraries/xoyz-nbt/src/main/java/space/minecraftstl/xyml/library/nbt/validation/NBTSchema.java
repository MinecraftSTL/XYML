...
import space.minecraftstl.xyml.library.nbt.internal.schema.*;
...
public sealed interface NBTSchema<T extends Tag> extends NBTValidator<T>
        permits space.minecraftstl.xyml.library.nbt.internal.schema.TagSchema {
    ...
    sealed interface Builder<T extends Tag> {
        ...
        sealed interface OfCompoundTag extends Builder<CompoundTag>
                permits space.minecraftstl.xyml.library.nbt.internal.schema.CompoundTagSchema.Builder {
