...
import space.minecraftstl.xyml.library.nbt.internal.snbt.SNBTWriter;
...
///
/// Each tag may have a [parent][#getParent()], which can be a [parent tag][ParentTag] or a [chunk][space.minecraftstl.xyml.library.nbt.chunk.Chunk].
...
public sealed abstract class Tag implements NBTElement
    ...
    ///
    /// Internal method, should only be called by [ParentTag] or [space.minecraftstl.xyml.library.nbt.chunk.Chunk] when adding or removing subtags.
    ///
    /// @see ParentTag
