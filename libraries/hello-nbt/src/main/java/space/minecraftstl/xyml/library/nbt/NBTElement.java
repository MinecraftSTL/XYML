...
///
/// An NBT element may be a child element of an [NBTParent] (such as a [CompoundTag][space.minecraftstl.xyml.library.nbt.tag.CompoundTag] or [ListTag][space.minecraftstl.xyml.library.nbt.tag.ListTag]).
///
