...
中文 ([简体](README.md), [繁體](README_zh_Hant.md), [文言](README_lzh.md)) | **English** (**Standard**, [uʍoᗡ ǝpᴉsd∩](README_en_Qabs.md)) | [日本語](README_ja.md) | [español](README_es.md) | [русский](README_ru.md) | [українська](README_uk.md)
...
XYML supports multiple operating systems and CPU architectures. See the [platform support table](PLATFORM_en.md) for exact
...
test audiences, feedback policies, and promotion order are documented in the [release model](ReleaseSchedule_en.md).
...
- Follow the [contributing guide](Contributing_en.md) to build, run, and debug XYML from source.
