...
**中文** (**简体**, [繁體](PLATFORM_zh_Hant.md)) | [English](PLATFORM_en.md)
...
* ✅️ 完整支持
  ...
  受到完整支持的平台。XYML 会尽可能为此平台提供支持。

* 🕰️ 有限支持

  这些平台通常是老旧的遗留平台。

  XYML 可以在这些平台上工作，但部分功能可能无法使用。
...
| ARM64                       | 👌 (Minecraft 1.8~1.18.2)<br/>✅ (Minecraft 1.19+) | 👌 (Minecraft 1.8~26.2)   | 👌 (Minecraft 1.6~1.18.2)<br/>✅ (Minecraft 1.19+)<br/>✅ (使用 Rosetta 2) | ❔                           |
...
* 👌: 支持的平台
  ...
  由 XYML 提供支持，经过测试可以正常运行，但可能比得到全面支持的平台有更多问题。
  不保证支持 Minecraft 1.6 以下的版本。
  如果你遇到在得到全面支持的平台上不存在的问题，可以向 XYML 反馈。

* ❔: 低级别支持的平台

  XYML 可以在这个平台上运行，并且有一些基本的支持。但是，还不能正常地启动游戏。
