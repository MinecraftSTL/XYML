...
| `XYML_ANIMATION_FRAME_RATE` |                                              | 設定 XYML 的動畫幀率                  | `60`                                                                                                        |              |
...
|                             | `-Dxyml.update_source.override=<url>`        | 設定 XYML 更新來源                    | `https://github.com/MinecraftSTL/XYML/releases/latest/download/xyml-update.json`                                                               |              |
