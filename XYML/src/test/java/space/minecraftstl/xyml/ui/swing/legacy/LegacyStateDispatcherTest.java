...
/// Verifies legacy-state serialization on the Swing event dispatch thread.
@NotNullByDefault
final class LegacyStateDispatcherTest {
    ...
    /// Direct legacy-state access rejects a worker thread.
    @Test
    void requireEventThreadRejectsWorkerThread() {
        assertThrows(IllegalStateException.class, LegacyStateDispatcher::requireEventThread);
    }
}
