...
import static space.minecraftstl.xyml.util.Lang.resolveException;
...
public final class LauncherHelper {
    ...
    public LauncherHelper(XYMLGameRepository repository, Account account, String selectedVersion) {
                ...
                .thenComposeAsync(authInfo -> Task.supplyAsync(() -> {
                    ...
                    return new XYMLGameLauncher(
                            ...
                            launcherVisibility == LauncherVisibility.CLOSE
                                    ...
                                    : new XYMLProcessListener(repository, version.get(), authInfo, launchOptions, launchingLatch, gameVersion.isPresent())
                    );
    ...
    private static Task<JavaRuntime> checkGameState(XYMLGameRepository repository, GameSettings.Effective setting, Version version) {
    ...
    private static CompletableFuture<JavaRuntime> downloadJava(GameJavaVersion javaVersion, XYMLGameRepository repository) {
        CompletableFuture<JavaRuntime> future = new CompletableFuture<>();
     ...
     * Guarantee that one [JavaProcess], one [XYMLProcessListener].
     * Because every time we launched a game, we generates a new [XYMLProcessListener]
     */
    private final class XYMLProcessListener implements ProcessListener {
        ...
        public XYMLProcessListener(XYMLGameRepository repository, Version version, AuthInfo authInfo, LaunchOptions launchOptions, CountDownLatch launchingLatch, boolean detectWindow) {
