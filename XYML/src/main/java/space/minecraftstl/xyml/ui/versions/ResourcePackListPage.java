...
import space.minecraftstl.xyml.ui.ListPageBase;
...
public final class ResourcePackListPage extends ListPageBase<ResourcePackListPage.ResourcePackInfoObject> implements VersionPage.GameInstanceLoadable {
    ...
    @Override
    public void loadInstance(XYMLGameRepository repository, String instanceId) {
                            ...
                            button.setOnAction(e -> {
                                ...
                                Controllers.navigate(new DownloadPage(
                                        repository instanceof CurseForgeRemoteAddonRepository
                                                ? XYMLLocalizedDownloadListPage.ofCurseForgeResourcePack(null, false)
                                                : XYMLLocalizedDownloadListPage.ofModrinthResourcePack(null, false),
                                        remoteAddon,
                                        new XYMLGameRepository.InstanceReference(page.repository, page.instanceId),
                                        space.minecraftstl.xyml.ui.download.DownloadPage.FOR_RESOURCE_PACK
                                ));
                            });
