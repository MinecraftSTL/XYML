 ...
 */
package space.minecraftstl.xyml.ui.construct;
...
import space.minecraftstl.xyml.download.fabric.FabricAPIInstallTask;
...
import space.minecraftstl.xyml.download.forge.ForgeOldInstallTask;
import space.minecraftstl.xyml.download.game.GameAssetDownloadTask;
import space.minecraftstl.xyml.download.game.GameInstallTask;
import space.minecraftstl.xyml.download.java.mojang.MojangJavaDownloadTask;
import space.minecraftstl.xyml.download.legacyfabric.LegacyFabricInstallTask;
import space.minecraftstl.xyml.download.liteloader.LiteLoaderInstallTask;
import space.minecraftstl.xyml.download.neoforge.NeoForgeInstallTask;
import space.minecraftstl.xyml.download.neoforge.NeoForgeOldInstallTask;
import space.minecraftstl.xyml.download.optifine.OptiFineInstallTask;
import space.minecraftstl.xyml.download.quilt.QuiltAPIInstallTask;
import space.minecraftstl.xyml.download.quilt.QuiltInstallTask;
import space.minecraftstl.xyml.game.XYMLModpackInstallTask;
import space.minecraftstl.xyml.java.JavaInstallTask;
...
import space.minecraftstl.xyml.modpack.curse.CurseCompletionTask;
import space.minecraftstl.xyml.modpack.curse.CurseInstallTask;
import space.minecraftstl.xyml.modpack.mcbbs.McbbsModpackCompletionTask;
import space.minecraftstl.xyml.modpack.mcbbs.McbbsModpackExportTask;
import space.minecraftstl.xyml.modpack.modrinth.ModrinthCompletionTask;
import space.minecraftstl.xyml.modpack.modrinth.ModrinthInstallTask;
...
import space.minecraftstl.xyml.modpack.multimc.MultiMCModpackInstallTask;
import space.minecraftstl.xyml.modpack.server.ServerModpackCompletionTask;
import space.minecraftstl.xyml.modpack.server.ServerModpackExportTask;
import space.minecraftstl.xyml.modpack.server.ServerModpackLocalInstallTask;
    ...
    public void setExecutor(TaskExecutor executor) {
        ...
        executor.addTaskListener(new TaskListener() {
            ...
            public void onRunning(Task<?> task) {
                ...
                } else if (task instanceof XYMLModpackInstallTask) {
