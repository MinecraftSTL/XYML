...
import space.minecraftstl.xyml.download.cleanroom.CleanroomRemoteVersion;
import space.minecraftstl.xyml.download.fabric.FabricAPIRemoteVersion;
import space.minecraftstl.xyml.download.fabric.FabricRemoteVersion;
import space.minecraftstl.xyml.download.forge.ForgeRemoteVersion;
import space.minecraftstl.xyml.download.game.GameRemoteVersion;
import space.minecraftstl.xyml.download.legacyfabric.LegacyFabricAPIRemoteVersion;
import space.minecraftstl.xyml.download.legacyfabric.LegacyFabricRemoteVersion;
import space.minecraftstl.xyml.download.liteloader.LiteLoaderRemoteVersion;
import space.minecraftstl.xyml.download.neoforge.NeoForgeRemoteVersion;
import space.minecraftstl.xyml.download.optifine.OptiFineRemoteVersion;
import space.minecraftstl.xyml.download.quilt.QuiltAPIRemoteVersion;
import space.minecraftstl.xyml.download.quilt.QuiltRemoteVersion;
...
import space.minecraftstl.xyml.ui.wizard.Refreshable;
import space.minecraftstl.xyml.ui.wizard.WizardPage;
import space.minecraftstl.xyml.util.NativePatcher;
