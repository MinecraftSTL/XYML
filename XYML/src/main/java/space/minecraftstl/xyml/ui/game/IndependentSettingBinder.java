 ...
 */
package space.minecraftstl.xyml.ui.game;
...
import space.minecraftstl.xyml.setting.property.SettingProperty;
import space.minecraftstl.xyml.ui.MemoryStatusBar;
import space.minecraftstl.xyml.ui.WeakListenerHolder;
import space.minecraftstl.xyml.ui.construct.LineComponent;
import space.minecraftstl.xyml.ui.construct.LineInheritableToggleButton;
import space.minecraftstl.xyml.ui.construct.RadioChoiceList;
import space.minecraftstl.xyml.util.Holder;
...
import static space.minecraftstl.xyml.util.DataSizeUnit.GIGABYTES;
...
final class IndependentSettingBinder {
    ...
    private static void updateMemoryStatus(
        ...
        if (Boolean.TRUE.equals(autoMemory)) {
            memoryAllocated = XYMLGameRepository.getAutoAllocatedMemory(memoryStatus.available());
