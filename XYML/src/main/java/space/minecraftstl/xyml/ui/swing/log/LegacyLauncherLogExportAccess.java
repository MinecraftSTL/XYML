...
/// Adapts the process-wide legacy logger to the testable launcher-log export boundary.
@NotNullByDefault
public final class LegacyLauncherLogExportAccess implements LauncherLogExportAccess {
    /// Prevents construction outside the explicit legacy adapter factory.
    private LegacyLauncherLogExportAccess() {
    }
    ...
    public static LegacyLauncherLogExportAccess createForCurrentLauncher() {
        return new LegacyLauncherLogExportAccess();
    }
