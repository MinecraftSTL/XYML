...
import static space.minecraftstl.xyml.download.RemoteVersion.Type.RELEASE;
import static space.minecraftstl.xyml.setting.SettingsManager.state;
import static space.minecraftstl.xyml.ui.FXUtils.SINE;
...
public final class MainPage extends StackPane implements DecoratorPage {
    ...
    public void initVersions(XYMLGameRepository repository, List<Version> versions) {
