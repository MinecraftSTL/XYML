...
/// Immutable account text captured by an account store without exposing authentication objects.
///
...
@NotNullByDefault
public record AccountDescriptor(String id, String title, String detail, String profileId) {
