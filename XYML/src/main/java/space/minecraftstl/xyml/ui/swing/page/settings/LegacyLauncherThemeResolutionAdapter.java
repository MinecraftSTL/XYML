...
/// Maps legacy launcher properties and override membership into one immutable theme-resolution request.
@NotNullByDefault
public final class LegacyLauncherThemeResolutionAdapter {
    /// Prevents utility instantiation.
    private LegacyLauncherThemeResolutionAdapter() {
    }
    ...
    /// Captures selected-theme and user-override values on the legacy state event thread.
    ///
    /// @param settings thread-confined loaded launcher settings
    /// @param context current theme resolution context
