...
import space.minecraftstl.xyml.addon.*;
...
import space.minecraftstl.xyml.util.Lazy;
                            ...
                            FXUtils.runInFX(() -> {
                                ...
                                button.setOnAction(e -> {
                                    ...
                                    Controllers.navigate(new DownloadPage(
                                            repository instanceof CurseForgeRemoteAddonRepository ? XYMLLocalizedDownloadListPage.ofCurseForgeMod(null, false) : XYMLLocalizedDownloadListPage.ofModrinthMod(null, false),
                                            remoteAddon,
                                            new XYMLGameRepository.InstanceReference(ModListPageSkin.this.getSkinnable().getRepository(), ModListPageSkin.this.getSkinnable().getInstanceId()),
                                            space.minecraftstl.xyml.ui.download.DownloadPage.FOR_MOD
                                    ));
                                });
