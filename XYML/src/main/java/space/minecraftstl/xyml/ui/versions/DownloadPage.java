...
import static space.minecraftstl.xyml.ui.FXUtils.onEscPressed;
...
public class DownloadPage extends Control implements DecoratorPage {
    ...
    private final XYMLGameRepository.InstanceReference instanceReference;
    ...
    public DownloadPage(DownloadListPage page, RemoteAddon addon, XYMLGameRepository.InstanceReference instanceReference, @Nullable DownloadCallback callback) {
        this.page = page;
    ...
    public XYMLGameRepository.InstanceReference getInstanceReference() {
            ...
            pane.getChildren().add(spinnerPane);
            {
                ...
                FXUtils.onChangeAndOperate(control.loaded, loaded -> {
                    ...
                    if (control.instanceReference.repository() != null && control.instanceReference.instanceId() != null) {
                        XYMLGameRepository repository = control.instanceReference.repository();
    ...
    private static final class DependencyAddonItem extends LineButton {
        ...
        DependencyAddonItem(DownloadListPage page, RemoteAddon addon, XYMLGameRepository.InstanceReference instanceReference) {
            this.addon = addon;
            ...
            DownloadCallback callback = switch (type) {
                case MOD -> space.minecraftstl.xyml.ui.download.DownloadPage.FOR_MOD;
                case RESOURCE_PACK -> space.minecraftstl.xyml.ui.download.DownloadPage.FOR_RESOURCE_PACK;
                case SHADER_PACK -> space.minecraftstl.xyml.ui.download.DownloadPage.FOR_SHADER;
    ...
    public interface DownloadCallback {
        void download(DownloadProvider downloadProvider, XYMLGameRepository repository, @Nullable String version, RemoteAddon addon, RemoteAddon.Version file);
    }
}
