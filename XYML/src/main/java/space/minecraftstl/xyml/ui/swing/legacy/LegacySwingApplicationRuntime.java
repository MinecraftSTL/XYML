...
@NotNullByDefault
public final class LegacySwingApplicationRuntime implements AutoCloseable {
    ...
    private LegacySwingApplicationRuntime(
    ...
    /// Creates the production Swing runtime after legacy launcher state has been initialized.
    ///
    ...
    public static LegacySwingApplicationRuntime create(
    ...
    static LegacySwingApplicationRuntime createForCollaborators(
        ...
        LegacySwingApplicationRuntime runtime = new LegacySwingApplicationRuntime(
                composition,
    ...
    public void open() {
        if (closed.get()) {
            throw new IllegalStateException("Legacy Swing application runtime is closed");
        }
        composition.open();
    }
    ...
    private static void rethrowFailure(@Nullable Throwable failure) {
        ...
        throw new IllegalStateException("Failed to close legacy Swing application runtime", failure);
    }
