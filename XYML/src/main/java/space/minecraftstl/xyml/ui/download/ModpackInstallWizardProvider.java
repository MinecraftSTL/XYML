...
public final class ModpackInstallWizardProvider implements WizardProvider {
    ...
    public ModpackInstallWizardProvider(XYMLGameRepository repository) {
        this(repository, null, null);
    }

    public ModpackInstallWizardProvider(XYMLGameRepository repository, Path modpackFile) {
        this(repository, modpackFile, null);
    }

    public ModpackInstallWizardProvider(XYMLGameRepository repository, String updateVersion) {
        this(repository, null, updateVersion);
    }

    public ModpackInstallWizardProvider(XYMLGameRepository repository, Path modpackFile, String updateVersion) {
