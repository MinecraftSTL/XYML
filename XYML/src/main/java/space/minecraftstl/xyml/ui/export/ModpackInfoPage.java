 ...
 */
package space.minecraftstl.xyml.ui.export;
...
import static space.minecraftstl.xyml.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE;
import static space.minecraftstl.xyml.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_MODRINTH;
import static space.minecraftstl.xyml.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_SERVER;
...
public final class ModpackInfoPage extends Control implements WizardPage {
    ...
    private final XYMLGameRepository gameRepository;
    ...
    public ModpackInfoPage(WizardController controller, XYMLGameRepository gameRepository, String version) {
