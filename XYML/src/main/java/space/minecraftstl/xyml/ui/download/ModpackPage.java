...
import space.minecraftstl.xyml.ui.construct.LinePane;
import space.minecraftstl.xyml.ui.construct.LineTextPane;
...
public abstract class ModpackPage extends SpinnerPane implements WizardPage {
    ...
    public static final SettingsMap.Key<XYMLGameRepository> REPOSITORY = new SettingsMap.Key<>("REPOSITORY");
