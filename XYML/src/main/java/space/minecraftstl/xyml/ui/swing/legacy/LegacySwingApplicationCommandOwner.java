...
public final class LegacySwingApplicationCommandOwner implements AutoCloseable {
    ...
    /// Creates the production command owner around the legacy stable-ID task adapter.
    ///
    ...
    public LegacySwingApplicationCommandOwner(
    ...
    LegacySwingApplicationCommandOwner(
    ...
    private static ProductionLaunchBoundary createProductionBoundary(
        ...
        Objects.requireNonNull(accountReauthentication, "accountReauthentication");
        @Nullable LegacyLauncherLaunchTaskFactory taskFactory = null;
        try {
            taskFactory = new LegacyLauncherLaunchTaskFactory(
                    visibilityActions,
                    launchInteraction,
                    accountReauthentication);
    ...
    private static void rethrowFailure(@Nullable Throwable failure) {
        ...
        throw new IllegalStateException("Failed to close legacy Swing launch commands", failure);
    }
