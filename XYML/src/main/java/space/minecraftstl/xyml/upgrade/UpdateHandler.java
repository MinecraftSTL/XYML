...
import space.minecraftstl.xyml.EntryPoint;
import space.minecraftstl.xyml.Main;
import space.minecraftstl.xyml.Metadata;
import space.minecraftstl.xyml.java.JavaRuntime;
import space.minecraftstl.xyml.task.Task;
import space.minecraftstl.xyml.task.TaskExecutor;
import space.minecraftstl.xyml.ui.Controllers;
import space.minecraftstl.xyml.ui.UpgradeDialog;
...
import static space.minecraftstl.xyml.ui.FXUtils.checkFxUserThread;
...
public final class UpdateHandler {
    ...
    public static void updateFrom(RemoteVersion version) {
        ...
        Controllers.dialog(new UpgradeDialog(version, () -> {
            ...
            Task<?> task = new XYMLDownloadTask(version, downloaded);
